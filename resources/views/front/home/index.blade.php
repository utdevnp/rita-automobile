                    ...
                    <div class="blog_container blog_column4 owl-carousel">
                            ...
                            <article class="single_blog">
                                <figure>
                                    <div class="blog_thumb">
                                        <a href="#"><img src="{{ asset('frontend_assets/assets/img/blog/blog1.jpg') }}" alt=""></a>
                                    </div>
                                    <figcaption class="blog_content">
                                        <h4><a href="#">Aenean et nulla sociosqu ad litora torquent per</a></h4>
                                        <div class="post_meta">
                        ...
                        <div class="col-lg-3">
                            <article class="single_blog">
                                <figure>
                                    <div class="blog_thumb">
                                        <a href="#"><img src="{{ asset('frontend_assets/assets/img/blog/blog2.jpg') }}" alt=""></a>
                                    </div>
                                    <figcaption class="blog_content">
                                        <h4><a href="#">Class aptent eum Fiction Molestie Consequat</a></h4>
                                        <div class="post_meta">
                                            <p><a href="#">eCommerce</a> / 17 July</p>
                                        </div>
                                        <div class="post_desc">
                        ...
                        <div class="col-lg-3">
                            <article class="single_blog">
                                <figure>
                                    <div class="blog_thumb">
                                        <a href="#"><img src="{{ asset('frontend_assets/assets/img/blog/blog3.jpg') }}" alt=""></a>
                                    </div>
                                    <figcaption class="blog_content">
                                        <h4><a href="#">Coconut Lemon Bath & Shower Gel Juice</a></h4>
                                        <div class="post_meta">
                                            <p><a href="#">eCommerce</a> / 17 July</p>
                                        </div>
                                        <div class="post_desc">
                        ...
                        <div class="col-lg-3">
                            <article class="single_blog">
                                <figure>
                                    <div class="blog_thumb">
                                        <a href="#"><img src="{{ asset('frontend_assets/assets/img/blog/blog4.jpg') }}" alt=""></a>
                                    </div>
                                    <figcaption class="blog_content">
                                        <h4><a href="#">Aenean et nulla sociosqu ad litora torquent per</a></h4>
                                        <div class="post_meta">
