                ...
                <div class="col-lg-4 col-md-4">
                    <div class="col text-center text-md-left">
                        ...
                        <div class="payment-option">
                            <ul>
                                <li><a href="#"><img src="{{ asset('frontend/images/visa.png') }}"></a></li>
                                <li><a href="#"><img style="height: 35px;" src="{{ asset('frontend/images/mastercard.png') }}"></a></li>
                                <li><a href="#"><img style="height: 30px;" src="{{ asset('frontend/images/verified_by_visa.png') }}"></a></li>
                                <li><a href="#"><img style="height: 20px;" src="{{ asset('frontend/images/mastercode-secure.png') }}"></a></li>
                            </ul>
                        </div>
                    </div>
                </div>
