                                ...
                                <div class="box-content">
                                    <div class="category-filter">
                                        <ul>
                                            ...
                                            @if(isset($category_id))
                                                <li class="active"><a
                                                        href="{{ route('products') }}">{{__('All Categories')}}</a></li>
                                                <li class="active"><a
                                ...
                                <div class="box-content">
                                    <div class="range-slider-wrapper mt-3">
                                        ...
                                        <div id="input-slider-range"
                                             ...
                                             data-range-value-max="{{ filter_products(\App\Product::query())->get()->max('unit_price') }}"></div>
                                        ...
                                        @foreach ($all_colors as $key => $color)
                                            <li>
                                                <input type="radio" id="color-{{ $key }}" name="color"
                                                       value="{{ $color }}"
                                                       @if(isset($selected_color) && $selected_color == $color) checked
                                                       @endif onchange="filter()">
                                                <label style="background: {{ $color }};" for="color-{{ $key }}"
                                                       data-toggle="tooltip"
                                            ...
                                            <div class="home-slide">
                                                <div class="home-slide">
                                                    <div class="slick-carousel" data-slick-arrows="true"
                                                         data-slick-dots="true" data-slick-autoplay="true">
                                                        @foreach (json_decode($banners) as $key => $banner)
                                                            <div class="" style="height:275px;">
                                                                <a href="#" target="_blank">
                                                                    <img class="d-block w-100 h-100 lazyload"
                                                                         src="{{ asset('frontend/images/placeholder-rect.jpg') }}"
                                                                         data-src="{{ asset($banner) }}"
